...
goods = [Good('hoodie', 'Худи oversize', 'https://downloader.disk.yandex.ru/preview/b0107dab45b96698fc71ef3e733c03184274f9921311e6abb4106d395d3361b9/6391a7d0/wMwcbZRjal0nVHZy81uINs3S99oXXjK-fpMRcXBvxLKMMKIxOgJ37QzrxiJl02AUR0968Obopc2JZeF0jhn0bQ%3D%3D?uid=0&filename=1Q8A5267.jpg&disposition=inline&hash=&limit=0&content_type=image%2Fjpeg&owner_uid=0&tknv=v2&size=1879x939', 'Худи черный оверсайз “Мы справимся”', 4500, True),
         ...
         Good('badge', 'Значок из серебра', 'https://downloader.disk.yandex.ru/preview/0c1362109183eed2db9a1446ce2f76f5f5fa4156e93de7dc8886add1b75731e5/63939eda/1vsODiiFsVhQPlPxMz4VA0ZapMCg5nGlwcb3fcNBNosd5uCMgRMNxkJ1QU6WhhYcT1FhuxfZ7UMGioxBrbYgFQ%3D%3D?uid=0&filename=badre.jpg&disposition=inline&hash=&limit=0&content_type=image%2Fjpeg&owner_uid=0&tknv=v2&size=2048x2048', 'Значок из серебра 925 пробы. Ручная работа.', 1300, False)]
...
def start3(message):
    bot.send_message(message.from_user.id, 'Легкий FAQ!\n\n'
                                           ...
                                           '- Только самовывоз и только во время проведения ВФТМ 8-12 декабря😎')
